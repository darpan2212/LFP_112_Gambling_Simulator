...
public class Gambler {
	public static final int STAKE = 100; // Gambler with the stake UC1
	public static final int BET = 1; // Bet value per game UC1
	...
	private static String getGame(String check) {
		...
		// Gambler's stakes each day for the whole month
		...
		if (totalDollars >= START_DOLLARS) {
			...
			check = "lost";
			System.out.println("Gambler lost total : " + totalDollars);
		}
		return check;
	}
}
